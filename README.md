...
> AI 에이전트와 그것을 안정적으로 운영하는 시스템을 만드는 개발자 **김종건**의 개인 포트폴리오 사이트
...
취업용 포트폴리오로, 경력·자격·프로젝트·연락처를 한 페이지에 담았습니다. AI 에이전트 구축을 중심으로, 시스템·보안 기반 위에서 **실제로 배포한 결과물**을 담았고, 수료증·논문·발표자료 등 증빙은 PDF로 직접 열람할 수 있습니다.
